    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_token', models.CharField(default=b'', max_length=255, verbose_name='auth_token', blank=True)),
                ('expires_time', models.DateTimeField(null=True, verbose_name='expires_time', blank=True)),
            ...
            managers=[
                ('objects', account.models.BkUserManager()),
            ],
        ),
    ]
